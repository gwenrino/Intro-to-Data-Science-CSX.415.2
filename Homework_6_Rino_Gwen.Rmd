...
2. The Whickham data frame has 1314 observations. Each observation is survey results from 1972-74 and 20 years later about one woman from Whickham, England.
...
The Central Limit Theorem states that the sampling distribution of sample means is approximately Normal, regardless of the distribution of your population.

1. Below is a random sample of size n = 10000 from a gamma(1,2) distribution and a histogram of the distribution.
